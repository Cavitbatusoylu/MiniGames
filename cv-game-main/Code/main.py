...
def start_game():
    ...
    while True:
        ...
        move0 = pygame.image.load(resource_path("move0.png")).convert_alpha()
        move0 = pygame.transform.scale(move0, (window_width / window_width * 330, window_height / window_height * 90))
        screen.blit(move0, (17, 210))

        shoot0 = pygame.image.load(resource_path("shoot0.png")).convert_alpha()
        ...
        flip0 = pygame.image.load(resource_path("flip0.png")).convert_alpha()
