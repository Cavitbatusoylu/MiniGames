...
class Player(pygame.sprite.Sprite):
    def __init__(self, pos, cwidth, speed, vwidth, screen, height):
        super().__init__()
        self.image0 = pygame.image.load(resource_path('player.png')).convert_alpha()
    ...
    def read_fingers(self):
        ...
        # Handle different return formats from cvzone
            ...
            try:
                if isinstance(hand, dict) and 'bbox' in hand:
                    ...
                    if lm:
                        ...
                        # Use center if available, otherwise use default
    ...
    def update(self):
        if self.read_fingers():
            ...
            if self.fingers[1] == 1:
                shoot1 = pygame.image.load(resource_path('shoot1.png')).convert_alpha()
                ...
                if self.game_state == 2 or self.game_state == 4:
                    self.game_state = 3
                flip1 = pygame.image.load(resource_path('flip1.png')).convert_alpha()
                flip1 = pygame.transform.scale(flip1,(self.ww / self.ww * 330, self.wh / self.wh * 90))
                self.screen.blit(flip1, (17, 400))
            else:
                move1 = pygame.image.load(resource_path('move1.png')).convert_alpha()
