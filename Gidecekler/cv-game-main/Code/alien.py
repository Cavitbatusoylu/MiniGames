...
class Alien(pygame.sprite.Sprite):
    def __init__(self,color,x,y,flipped):
        super().__init__()
        file_path = os.path.join(os.path.dirname(__file__), '..', 'Resources', color + '.png')
...
class Extra(pygame.sprite.Sprite):
    def __init__(self,side,window_width, video_width, flipped):
        super().__init__()
        self.image0 = pygame.image.load(os.path.join(os.path.dirname(__file__), '..', 'Resources', 'extra.png')).convert_alpha()
